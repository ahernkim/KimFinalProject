...
# Initial set up for importing Dataframe
...
for index, row in pp_2021_tidy.iterrows():  #Use Iterrows to loop over the DataFrame
    print(index)
    print(row)
...
jan_df = price_df.loc["02/01/2020":"31/01/2020"]  #create a new dataframe loc.
...
data_mean_20 = {'Means': [240564.786401, 255561.398529, 255593.268327, 251242.985103,
                ...
                'Frame': ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October',
                          'Nov',
                          'Dec']}
...
print(jan_df21_mean)
print("January 21 average house price was", jan_df21.mean)
feb_df21 = price_df21.loc["01/02/2021":"26/02/2021"]
feb_df21_mean = feb_df21.mean()
print("February 21 average house price was", feb_df21.mean())
march_df21 = price_df21.loc[("01/03/2021"):("31/03/2021")]
march_df_mean = march_df21.mean()
print("March 21 average house price was", march_df21.mean())
april_df21 = price_df21.loc[("01/04/2021"):("16/04/2021")]
april_df_mean = april_df21.mean()
print("April 21 average house price was", april_df21.mean())

# Create a dictionary from the means of the houses sold in 2021
...
# print(data_df21) # check dataframe
...
print("Working out the number houses sold per month in 2020..")

print("The count is", jan_df.count())  ##Using count to check number of houses sold per month
print("The count is", feb_df.count())
print(print("The count is", march_df.count()))
print("The count is", april_df.count())
print("The count is", may_df.count())
print("The count is", june_df.count())
print("The count is", july_df.count())
print("The count is", aug_df.count())
print("The count is", sept_df.count())
print("The count is", oct_df.count())
print("The count is", nov_df.count())
print("The count is", dec_df.count())

# Create a dictionary from the number of houses sold.
data_count_20 = {'Sold': [389, 401, 550, 290, 330, 373, 357, 260, 523, 574, 532, 787],

                 'Frame': ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nov',
                           'Dec']}

# Make dataframe from dictionary
count_df = pd.DataFrame(data_count_20, columns=['Sold', 'Frame'])

print(count_df)

# Plot new dataframe
count_df.plot(kind = 'scatter', x='Frame', y='Sold')
plt.title('Number of houses sold in the months of 2020')
plt.show()


print("Reviewing how many houses were sold in 2021...")

print("The count for Jan 21 is", jan_df21.count())
print("The count for Feb 21", feb_df21.count())
print(print("The count for March 21", march_df21.count()))
print("The count for April 21", april_df21.count())

# Create a dictionary from the count.
data_count_21 = {'Sold': [357, 434, 505, 107],

                 'Frame': ['Jan', 'Feb', 'March', 'April']}

# Make dataframe from dictionary
count_df21 = pd.DataFrame(data_count_21, columns=['Sold', 'Frame'])
print(count_df21)

# Plot new dataframe using scatter
count_df21.plot(kind='scatter', x='Frame', y='Sold')
plt.title('Number of houses sold in the months of 2021')
plt.show()

# Created a new dataset selecting only rows with New Dwelling.
print("Reviewing New Dwelling Houses/Apartments sold in 2020 and 2021")
...
# print("Printing all houses sold in December 2020", december_df)
# print(december_df.head())
# print(december_df.shape)
december_price_np = np.array(december_df[1:], dtype=float)  ##Create numpy array using prices from December
print(december_price_np)

december_mean = np.mean(december_price_np)
december_min = np.min(december_price_np)
december_max = np.max(december_price_np)

print("The Average a house sold for in December 2020 was", december_mean)
print("The Minimum a house house sold in December 2020 was", december_min)
print("The Maximum a house sold for in December 2020 was ", december_max)

november_df = check_df.loc[
              ("01/11/2020"):("30/11/2020")]  # find all houses listed from the start of November to the end
...
print("The Average a house sold for in November 2020 was", november_mean)
print("The Minimum a house sold for in November 2020 was", november_min)
print("The Maximum a house sold for in November 2020 was ", november_max)
