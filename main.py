...
data_mean = {'Means': [240564.786401, 255561.398529, 255593.268327, 251242.985103,
...
data_df = pd.DataFrame(data_mean, columns=['Means', 'Frame'])
print(data_df)
...
jan_df_merge = merge.loc["02/01/2020":"31/01/2020"]
jan_df_merge_mean = jan_df_merge.mean()
print("Januarys average house price for a New Dwelling price was", jan_df_merge.mean)
feb_df_merge = merge.loc["03/02/2020":"29/02/2020"]
feb_df_merge_mean = feb_df_merge.mean()
print("February's average house price for a New Dwelling price was", feb_df_merge.mean())
march_df_merge = merge.loc[("02/03/2020"):("31/03/2020")]
march_df_merge_mean = march_df_merge.mean()
print("March's average house price for a New Dwelling price was", march_df_merge.mean())
april_df_merge = merge.loc[("01/04/2020"):("30/04/2020")]
april_df_merge_mean = april_df_merge.mean()
print("Aprils average house price for a New Dwelling price was", april_df_merge.mean())
may_df_merge = merge.loc[("01/05/2020"):("29/05/2020")]
may_df_merge_mean = may_df_merge.mean()
print("Mays average house price for a New Dwelling price was", may_df_merge.mean())
june_df_merge = merge.loc[("01/06/2020"):("30/06/2020")]
june_df_merge_mean = june_df_merge.mean()
print("Junes average house price for a New Dwelling price was", june_df_merge.mean())
july_df_merge = merge.loc[("01/07/2020"):("31/07/2020")]
july_df_merge_mean = july_df_merge.mean()
print("Julys average house price for a New Dwelling price was", july_df_merge.mean())
aug_df_merge = merge.loc[("03/08/2020"):("31/08/2020")]
aug_df_merge_mean = aug_df_merge.mean()
print("August average house price for a New Dwelling price was", aug_df_merge.mean())
sept_df_merge = merge.loc[("01/09/2020"):("30/09/2020")]
sept_df_merge_mean = sept_df_merge.mean()
print("September average house price for a New Dwelling price was", sept_df_merge.mean())
oct_df_merge = merge.loc[("01/10/2020"):("31/10/2020")]
oct_df_merge_mean = oct_df_merge.mean()
print("October average house price for a New Dwelling price was", oct_df_merge.mean())
nov_df_merge = merge.loc[("01/11/2020"):("30/11/2020")]
nov_df_merge_mean = nov_df_merge.mean()
print("November average house price for a New Dwelling price was", nov_df_merge.mean())
dec_df_merge = merge.loc[("01/12/2020"):("31/12/2020")]
dec_df_merge_mean = dec_df_merge.mean()
print("December average house price for a New Dwelling price was", dec_df_merge.mean())
